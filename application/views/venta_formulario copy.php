                ...
                <div class="checkout">
                    ...
                    <div class="checkout__order">
                        <div class="checkout__order-inner">
                            ...
                            <a href="javascript:void(0);" class="btn btn-default checkout__cancel">Continue Shopping</a>
                            <a href="javascript:void(0);" class="btn btn-success">Buy</a>
                            <a href="javascript:void(0);" class="checkout__close checkout__cancel"><i class="icon fa fa-times"></i>Close</a>
                        </div>
                    </div>
                </div>
