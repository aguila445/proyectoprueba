            ...
            <div class="page-inner">
                ...
                <div id="main-wrapper">
                    <div class="row">
                     ...
                     <input type="search" name="nombreFraterno" id="nombreFraterno" placeholder="Escriba el nombre del fraterno" class="form-control">
                      <div id="fraternoResultados"></div>
                <br>
                <label for="nombreProducto">Producto</label>
                <input type="search" name="nombreProducto" id="nombreProducto" placeholder="Escriba el nombre del producto" class="form-control">
...
<div>
                           ...
                           <div>
                            <br>
                            <br>
                            <button type="button" class="btn btn-success" id="cancelarVenta">Cancelar</button>
