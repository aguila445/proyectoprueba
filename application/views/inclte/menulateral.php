<div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        -->
                        <li><a href="<?php echo base_url(); ?>index.php/fraterno/productos" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-briefcase"></span><p>PRODUCTOS</p> <!--<span class="arrow"> </span> --></a>
                        <!--    <ul class="sub-menu">
